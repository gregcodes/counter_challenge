...
#import data
setwd("C:/Users/Grigori/Desktop/Python/")
...
# reverse order: sort by name and then by date increasing
## duplicates <- duplicates[order(Target.CUSIP, Count, Date.Announced.Fixed)]
## duplicates[order(Date.Announced, Target.Name, )]

# algorithm that sets every other bid that is in range of 60 days of a first bid to 0
# also possible to implement with pulling out each unique target incl duplicates and a foreach loop
